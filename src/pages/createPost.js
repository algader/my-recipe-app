import { IonPage, IonContent, IonItem, IonList, IonLabel, IonInput, IonTextarea, IonText, IonIcon, IonButton,  IonImg, IonToast, IonAlert }  from "@ionic/react"
    ...
    const validator = () => {
        ...
        if(photos.length > 0) {
            ...
            if (steps && title && content) {
                ...
                // console.log("يمكنك إرسال البيانات ")
